...
def _build_defaults() -> dict:
    ...
    return {
        ...
        "broker": {
            ...
            "artemis_data":    f"{root}/loop/artemis-broker",
...
MENU_SCHEMA = [
    ...
    },
    {
        "label": "Broker",
        "key": "broker",
        "help": "Artemis, Redis (migration target), and ComfyUI connection parameters",
        "children": [
            {"label": "RabbitMQ URL (legacy)", "key": "rabbitmq_url",    "type": "string",
             "help": "AMQP 0-9-1 URL — remove after Artemis migration (steps 9/12)"},
            {"label": "Redis URL (legacy)",    "key": "redis_url",       "type": "string",
             "help": "Redis URL — remove after SQLite migration (steps 6/10/11)"},
            {"label": "Artemis STOMP URL",     "key": "stomp_url",       "type": "string",
             "help": "Artemis STOMP URL for Python processes (step 12)"},
            {"label": "Artemis console",       "key": "artemis_console", "type": "string",
             "help": "Hawtio management console URL (replaces RabbitMQ mgmt on :15672)"},
            {"label": "Artemis broker data",   "key": "artemis_data",    "type": "string",
             "help": "Path to Artemis broker instance created with: artemis create <path>"},
