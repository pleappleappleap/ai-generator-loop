...
MENU_SCHEMA = [
    ...
    },
    {
        "label": "Broker",
        "key": "broker",
        "help": "RabbitMQ, Redis, and ComfyUI connection parameters",
        "children": [
            {"label": "RabbitMQ URL", "key": "rabbitmq_url", "type": "string",
             "help": "AMQP connection URL (amqp://user:pass@host:port)"},
            {"label": "Redis URL",    "key": "redis_url",    "type": "string",
             "help": "Redis connection URL (redis://host:port)"},
